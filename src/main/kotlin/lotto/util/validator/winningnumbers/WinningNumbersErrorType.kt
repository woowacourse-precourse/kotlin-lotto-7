package lotto.util.validator.winningnumbers

enum class WinningNumbersErrorType(
    private val _errorMessage: String
) {
    EMPTY_INPUT("당첨 번호는 빈 문자를 입력하면 안 됩니다."),
    NOT_DECIMAL("당첨 번호는 소수를 입력하면 안 됩니다."),
    NOT_INTEGER("당첨 번호는 정수 외 다른 것을 입력하면 안 됩니다."),
