...
- [ ] 로또 구입 금액을 입력 받는 함수
- [ ] 입력 받은 구입 금액을 검증하는 함수
    - [ ] 1,000단위로 나누어 떨어지지 않으면 예외 처리
    - [ ] "[ERROR] 구입 금액은 1,000원 단위 이상 구입이 가능합니다."를 출력
    - [ ] 다시 입력 받는 함수를 호출
...
- [ ] 로또 번호를 추첨하는 함수
- [ ] 로또 번호를 오름차순으로 정렬하는 함수
- [ ] 로또 번호를 출력하는 함수
    - [ ] "[1, 3, 5, 14, 22, 45]"를 출력


- [ ] 당첨 번호를 입력 받는 함수
- [ ] 입력 받은 당첨 번호를 콤마로 구분하는 함수
- [ ] 입력 받은 당첨 번호를 검증하는 함수
    - [ ] 입력 받은 번호가 1~45 사이인가?
    - [ ] 입력 받은 번호의 개수가 6개인가?
    - [ ] 중복된 숫자가 없는가?

    - [ ] "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다."를 출력
    - [ ] 예외 처리 시 다시 입력 받는 함수 호출


- [ ] 보너스 번호를 입력 받는 함수
- [ ] 입력 받은 보너스 번호를 검증하는 함수
    - [ ] 입력 받은 번호가 1~45 사이인가?
    - [ ] 입력 받은 번호의 개수가 1개인가?
    - [ ] 당첨 번호와 중복되지 않는가?
    - [ ] "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다."를 출력
...
- [ ] 5개 번호가 일치할 때 보너스 번호 당첨을 확인하는 함수
