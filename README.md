...
- [ ] `보너스 번호를 입력해 주세요.` 안내 메시지를 출력한다.
- [ ] 사용자로부터 보너스 번호를 입력받는다.

<br>

### 당첨 번호와 보너스 번호를 관리하는 기능

- [ ] 당첨 번호는 쉼표 기준으로 분리하여 보관한다.
- [ ] 당첨 번호를 반환하는 기능
...
- [ ] 로또 번호를 생성한다.
- [ ] `Randoms.pickUniqueNumbersInRange(1, 45, 6)`를 사용한다.
...
### 로또 예외 케이스
  - [ ] 로또 번호가 6개 아닌 경우
  - [ ] 로또 번호에 중복된 번호가 있는 경우
  - [ ] 로또 번호가 1~45 사이의 정수가 아닌 경우
